...
const Cal = () => {
  ...
  return (
    <div class="mx-auto overflow-hidden mt-10 shadow-lg mb-2 bg-[#4b2e2e] shadow-lg border rounded-lg lg:w-2/6 md:w-3/6 sm:w-4/6">
      <div class="">
        <div class="p-5 text-white text-center text-3xl bg-[#04387A]-900">
          Dots/Wilks
        </div>
        <div class="pt-16 p-5 pb-0 text-white text-right text-3xl bg-[#608bff]">
          {cal || 0}
        </div>
